...
import ProductoForm from '../pages/Administrador/Producto/ProductoForm';
import ProductoList from '../pages/Administrador/Producto/ProductoList';
import InventarioForm from '../pages/Administrador/Inventario/InventarioForm';
import InventarioList from '../pages/Administrador/Inventario/InventarioList';
    ...
    <ProtectedRoute requiredRoles={["Administrador"]}>
        <Routes>
            ...
            <Route path="productos/:id/edit" element={<ProductoForm />} />
                {/* RUTA DEL inventarios */}
            <Route path="inventarios" element={<InventarioList />} />
            <Route path="inventarios/new" element={<InventarioForm />} />
            <Route path="inventarios/:id/edit" element={<InventarioForm />} />
